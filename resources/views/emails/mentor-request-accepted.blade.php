...
<head>
    ...
    <title>Mentorship Request Accepted - {{ $appName }}</title>
</head>
    ...
    <div style="position: relative; z-index: 1; max-width: 600px; margin: 0 auto; padding: 40px 20px;">
        ...
        <div style="background: rgba(255, 255, 255, 0.05); backdrop-filter: blur(20px); border-radius: 24px; border: 1px solid rgba(255, 255, 255, 0.1); padding: 40px; margin-bottom: 30px; box-shadow: 0 20px 40px rgba(0, 0, 0, 0.3);">
            ...
            <div style="text-align: center; margin-bottom: 30px;">
                ...
                <p style="color: rgba(255, 255, 255, 0.8); font-size: 16px; margin: 0;">Congratulations! You now have a mentor!</p>
            </div>
            ...
            <div style="background: rgba(34, 197, 94, 0.1); border-radius: 16px; padding: 30px; border: 1px solid rgba(34, 197, 94, 0.2); margin-bottom: 30px;">
                ...
                <h2 style="color: #ffffff; font-size: 24px; font-weight: 600; text-align: center; margin: 0 0 15px 0;">Mentorship Request Accepted!</h2>
                
                <p style="color: rgba(255, 255, 255, 0.9); font-size: 18px; text-align: center; margin: 0 0 20px 0; line-height: 1.6;">
                    <strong style="color: #22c55e;">{{ $mentorName }}</strong> has accepted your mentorship request!
                </p>

                <p style="color: rgba(255, 255, 255, 0.7); font-size: 14px; text-align: center; margin: 0; line-height: 1.5;">
                    Your academic journey just got better! {{ $mentorName }} will guide you and help you achieve your goals.
                </p>
            </div>

            <!-- Action Buttons -->
            <div style="text-align: center; margin-bottom: 30px;">
                <a href="{{ $profileUrl }}" style="display: inline-block; background: linear-gradient(135deg, #8B7FD3 0%, #635985 100%); color: #ffffff; text-decoration: none; padding: 16px 32px; border-radius: 12px; font-weight: 600; font-size: 16px; box-shadow: 0 8px 24px rgba(139, 127, 211, 0.4); transition: all 0.3s ease; margin: 0 10px 10px 0;">
                    View {{ $mentorName }}'s Profile
                </a>
                <a href="{{ $dashboardUrl }}" style="display: inline-block; background: rgba(255, 255, 255, 0.1); color: #ffffff; text-decoration: none; padding: 16px 32px; border-radius: 12px; font-weight: 600; font-size: 16px; border: 1px solid rgba(255, 255, 255, 0.2); transition: all 0.3s ease; margin: 0 0 10px 0;">
                    Go to Dashboard
                </a>
            </div>
