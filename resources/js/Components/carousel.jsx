...
export default function Carousel({
  ...
  // Ensure we don't append undefined when items is empty
  ...
  // Graceful empty state: render nothing to avoid runtime errors
            ...
            <motion.div
              ...
              onTap={() => {
                if (typeof onItemClick === 'function') {
                  onItemClick(items[originalIndex]);
                }
              }}
            >
              <div className="relative w-full aspect-[16/9] overflow-hidden">
                ...
                {showImageOverlay && (
                  <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent" />
                             ...
                             <div className="p-5">
                 <div className={`mb-1 font-black text-lg ${showImageOverlay ? 'text-white' : 'text-white'}`}>
                   {item.title}
                 </div>
                 <p className={`text-sm ${showImageOverlay ? 'text-white' : 'text-gray-200'}`}>{item.description}</p>
               </div>
            </motion.div>
          );
        })}
